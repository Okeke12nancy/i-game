...
authRouter.get("/profile", authMiddleware.authMiddlewares, AuthController.getProfile);
authRouter.post("/logout", authMiddleware.authMiddlewares, preventLogoutIfInSession, AuthController.logout);
