...
gameRouter.post("/session/create", GameController.createSession);
gameRouter.post(
  "/session/join",
  validateMiddleware.validate(validateMiddleware.schemas.selectNumber),
  authMiddleware.checkoutActiveSession,
  GameController.joinSession
);
